...
update_particles_with_odom(): This function finds the change in the robot's position since it was last updated. It then adds these changes in position to each particle as if each particle had the same position and orientation as the robot.  
